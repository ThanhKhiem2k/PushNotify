...
export default class ConnectAPIServer {
  ...
  constructor() {
    ...
    this.FirebaseServerKey = 'AAAAGrQgKzE:APA91bF-za6CdbH9YKuZWEPedsqwWlTUbYZUo5JqN7im6z6WIZqU_ad61B2ppDh7lbdZhQTzYpXU7lRqg-29RhZaR7HtmXhsuToF-Art_cfQL3qeNPh-daxsvDR_OIhiIqkZRL2MIiJ2NguyenThanhKhiem';
